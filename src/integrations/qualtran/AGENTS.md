...
- Preserve unrelated dirty work in this integration tree. Do not revert deleted, modified, or untracked files unless the user explicitly requests it.
